...
--><div class="col-lg-8" style="margin:15px;">
	...
	<div class="control-group form-group">
    	<div class="controls">
        	<label>Name:</label>
            	<input type="text" value="<?php echo @$res['Name'];?>" name="n" readonly="true" class="form-control" required>
        </div>
   	</div>
	...
	<div class="control-group form-group">
    	<div class="controls">
        	<label>Designation:</label>
            	<input type="text" value="<?php echo @$res['designation'];?>" name="desg" readonly="true" class="form-control" required>
        </div>
   	</div>
	...
	<div class="control-group form-group">
    	<div class="controls">
          ...
          <input type="password" value="<?php echo @$res['password'];?>"  name="pass" readonly="true" class="form-control" required>
        </div>
    </div>
