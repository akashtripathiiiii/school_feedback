	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input class="form-control" value="<?php echo $res['name'];?>"  type="text" readonly="true" name="n"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<Td>
				Male<input type="radio" <?php if($res['gender']=="m"){echo "checked";} ?> name="gen" readonly="true" value="m"/>
				Female<input type="radio" <?php if($res['gender']=="f"){echo "checked";} ?> name="gen" readonly="true" value="f"/>	
					</td>
				</tr>
