      ...
      <div class="row">
		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder" style:"background-color:#F0F8FF">
              
              <h3>Name</h3>
              <span style="font-size:18.0pt" class="text-muted"><?php echo $users['name'];?></span>
            	</div>

            <div class="col-xs-6 col-sm-3 placeholder">
              
              <h3>E-mail</h3>
              <span style="font-size:18.0pt" class="text-muted"><?php echo $users['email'];?></span>
            </div>

            <div class="col-xs-6 col-sm-3 placeholder">
              
              <h3>Program</h3>
              <span style="font-size:18.0pt" class="text-muted"><?php echo $users['programme'];?></span>
            </div>

            <div class="col-xs-6 col-sm-3 placeholder">
              
              <h3>Year</h3>
              <span style="font-size:18.0pt" class="text-muted"><?php echo $users['semester'];?></span>
            </div>
          </div>
