...
<head>
	...
	<title>Feedback Analyzer System</title>
...
<body style="background-color:#F8F8FF">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#191970">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:WHITE">Feedback Analyzer System</a>
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<img src="images/front.jpg" alt="front image" width=100% height="500">
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#191970">
		<span style="color:WHITE">Developed By Akash Srivastava I1910049 </span>
	</div>
    <!-- jQuery -->
